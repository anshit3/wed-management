...
$( "#car-select-form" ).submit(function() {
  ...
  var selectedCar2 = $("#car-select2").find(":selected").text();
  var selectedCarVal2 = $("#car-select2").find(":selected").val();
  ...
  if(validateNotEmpty(selectedCarVal2)) { error = 1; }
  ...
  if(0 == error)
  {
    ...
    $("#selected-car-ph2").html(selectedCar2);
    $("#selected-car2").val(selectedCar2);
